...
/*
        ...
        for(int i = 0; i < predictionHorizon; i++){
            predictedPath[i] = new Vector2D(vars[stateVars * i + X], vars[stateVars * i + Y]);
        }

        return new Controls(vars[steeringStart + DELTA],
                vars[stateVars + V], vars[steeringStart + A],
                predictedPath, polynomialPath);
    }

    public static void main(String[] args) {
        System.out.println("starting MPC");
        ...
        while(true){
            try{
                ...
                if(msg != null){
                    ...
                    System.out.println(pathCoeffs[2] + "x^2 + " + pathCoeffs[1] + "x + " + pathCoeffs[0]);
